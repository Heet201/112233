...
import { Tenant, Ticket, CategoryDetail, TicketPriority } from '../types';
import AgentPortal from './AgentPortal';
import { SUPPORT_CATEGORIES } from '../data';
...
export default function SuperAdminPortal({
  ...
  const [activeTab, setActiveTab] = useState<'tenants' | 'support'>(initialTab);
    ...
    <div className="flex-1 overflow-y-auto bg-[#faf9f8] p-6 font-sans text-slate-800">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {activeTab === 'tenants' ? (
          ...
          /* Tab 2: Full Trueline Agent Workspace Portal (Same layout as Subscriber Support Desk) */
          <div className="-mx-6 -my-6 bg-[#f3f2f1]">
            <AgentPortal
              tickets={tickets}
              categories={categories}
              onUpdateStatus={onUpdateStatus || (() => {})}
